function pesquisar() {
  ...
  if (valorPesquisa === "") {
      erroParagrafo.innerText = "Faça uma busca";
  ...
  for (let dado of artistas) {
      // Verifica se o título do artista inclui o valor da pesquisa
  ...
  if (resultados.trim() === "") {
      erroParagrafo.innerText = "Artista não encontrado ou não cadastrado.";
      erroParagrafo.style.display = "block";
      section.style.display = "none";
  } else {
      erroParagrafo.style.display = "none";
